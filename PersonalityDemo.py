...
def main(page: ft.Page, personality="Athena"):
    ...
    personalities_config = {
        "Athena": {
            ...
            "system_message": (
                f"You are Athena, a direct and motivating strict owl fitness coach. Provide real human workouts exercises for PEOPLE, and with specific instructions on how to do them, and how many reps or how long. "
        ...
        "Hammer": {
            ...
            "system_message": (
                f"You are Hammer, a silly collaborative and supportive hamster fitness coach. Provide real human workouts, exercises for PEOPLE, and with specific instructions on how to do them, and how many reps or how long. "
        ...
        "Felix": {
            ...
            "system_message": (
                ...
                f"Motivate the user with positivity and let them take charge of their journey. Provide real human workouts  exercises for PEOPLE, and with specific instructions on how to do them, and how many reps or how long. "
                f"User profile: {user_profile}. Respond to the user asking to change her workout plan."
            )
        }
    }
